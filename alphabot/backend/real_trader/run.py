...
def initialize(context):
    ...
    # 测试jqdata数据
    print(get_price('000001.XSHE', start_date='2019-12-01 14:00:00', end_date='2019-12-02 12:00:00', frequency='1m'))
...
# 初始化jqdatasdk
#auth('聚宽账号','聚宽密码')
auth('13520312255','Zdf6664518')

# 初始化实盘模块
#init_trader(g, context, '资金账号', '资金密码', r'D:\MyTrading\agents\中泰证券独立下单\xiadan.exe')
init_trader(g, context, '22224090', '115174', r'D:\MyTrading\agents\中信建投网上交易极速版-同花顺\xiadan.exe')
