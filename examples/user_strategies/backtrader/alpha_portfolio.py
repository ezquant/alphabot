# -*- coding: utf-8 -*-
# ref: https://cloud.tencent.com/developer/article/1388267
# brief: 使用 backtrader 实现 rqalpha 之类的这种全市场、组合回测的示例
# desc: 代码注释比较全面，基本实现了涨跌停不能买入，进入排队等待，当日开盘价买入，滑点设置等等这些功能。
